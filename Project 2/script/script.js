...
let arr = [];
// function findZeroToOpen(mat, row, cloumn) {
//     let num = {
//         value: mat[row][cloumn].value,
//         i: row,
//         j: cloumn
//     }
//     console.log(num);
...
//         openZero(arr[index], mat);
//     }
// }

// function openZero(num, mat) {
//     console.log(num);
//     let num1 = {
//         value: 0,
//         i: num.i,
...
//     }
//     if (num.i !== 0) {
//         if (mat[num.i - 1][num.j].value !== 0) {
//             open(mat, num.i - 1, num.j);
//         }
//         else if(mat[num.i - 1][num.j].cheaked === false){
//             open(mat, num.i - 1, num.j);
//             num1.value = mat[num.i - 1][num.j].value;
//             num1.i = num.i - 1;
//             numn1.j = num.j
//             arr.push(num1);
//         }
//         if (num.j !== 0) {
//             if (mat[num.i - 1][num.j - 1].value !== 0) {
//                 open(mat, num.i - 1, num.j - 1);
//             }
//             else if(mat[num.i - 1][num.j-1].cheaked === false){
//                 open(mat, num.i - 1, num.j - 1);
//                 num1.value = mat[num.i - 1][num.j - 1].value;
//                 num1.i = num.i - 1;
//                 numn1.j = num.j - 1
//                 arr.push(num1);
//             }
...
//     }
//     if (num.j !== 0) {
//         if (mat[num.i][num.j - 1].value !== 0) {
//             open(mat, num.i, num.j - 1);
//         }
//         else if(mat[num.i ][num.j-1].cheaked === false) {
//             open(mat, num.i, num.j - 1);
//             num1.value = mat[num.i][num.j - 1].value;
//             num1.i = num.i;
//             numn1.j = num.j - 1
//             arr.push(num1);
//         }
...
// function open(mat, i, j) {
//      let tr=document.querySelectorAll('table tr'); 
//      console.log(tr)
//      tr[i].id="me";
//      let td=document.querySelectorAll('#me td')
//      console.log(td)
//      let obj=td[j];
//     switch (mat[i][j].value) {
//         case 0: {
//             // event.target.classList = "num0";
//             mat[i][j].class = "num0";
//             obj.children[0].src = "../img/0.png"
//             console.log(obj.children[0].src);
//             break;
//         }
//         case 1: {
//             // event.target.classList = "num1";
//             mat[i][j].class = "num1"
//             obj.children[0].src = "../img/1.png"
//             console.log(obj.children[0].src);
//             break;
//         }
//         case 2: {
//             // event.target.classList = "num2";
//             mat[i][j].class = "num2"
//             obj.children[0].src = "../img/2.png"
//             console.log(obj.children[0].src);
//             break;
//         }
//         case 3: {
//             // event.target.classList = "num3";
//             mat[i][j].class = "num3"
//             obj.children[0].src = "../img/3.png"
//             console.log(obj.children[0].src);
//             break;
//         }
//         case 4: {
//             // event.target.classList = "num4";
//             mat[i][j].class = "num4"
//             obj.children[0].src = "../img/4.png"
//             console.log(obj.children[0].src);
//             break;
//         }
//         case 5: {
//             // event.target.classList = "num5";
//             mat[i][j].class = "num5"
//             obj.children[0].src = "../img/5.png"
//             console.log(obj.children[0].src);
//             break;
//         }
//         case 6: {
//             // event.target.classList = "num6";
//             mat[i][j].class = "num6"
//             obj.children[0].src = "../img/6.png"
//             console.log(obj.children[0].src);
//             break;
//         }
//         case 7: {
//             // event.target.classList = "num7";
//             mat[i][j].class = "num7"
//             obj.children[0].src = "../img/7.png"
//             console.log(obj.children[0].src);
//             break;
//         }
//         case 8: {
//             // event.target.classList = "num8";
//             mat[i][j].class = "num8"
//             obj.children[0].src = "../img/8.png"
//             console.log(obj.children[0].src);
//             break;
//         }
//     }
